 ...
 *  FluidApp
	...
	Part of Fluid Simulation that accelerates Intel and PowerPC code.
	
	Michael Fortin / TML / 2009, 2010, 2011
...
static const x128i x_simd_ione = {1,1,1,1};
...
//x_sel
#ifdef __APPLE_ALTIVEC__
	#define x_sel(a,b,c) vec_sel(a,b,c)
#elif defined __SSE3__
	#define x_sel(a,b,c) _mm_add_ps(_mm_andnot_ps(a,b),_mm_and_ps(a,c))
#else
	static inline x128f x_sel(x128i a,x128f b, x128f c)
	{
		return (x128f)
			{	a.a?a.a:b.a,
				a.b?a.b:b.b,
...
#elif defined __SSE3__
	#define x_cmp_lti(a,b)	_mm_cmplt_epi32(a,b)
#else
...
//x_cmp_lt
#ifdef __APPLE_ALTIVEC__
	#define x_cmp_lt(a,b)	vec_cmplt(a,b)
#elif defined __SSE3__
	#define x_cmp_lt(a,b)	_mm_cmplt_ps(a,b)
#else
	static inline x128i x_cmp_lt(const x128f a, const x128f b)
	{
		return	(x128i){
				a.a < b.a ? 0xFFFFFFFF : 0x0,
				a.b < b.b ? 0xFFFFFFFF : 0x0,
...
//x_and
#ifdef __APPLE_ALTIVEC__
	#define x_and(a,b) vec_and(a,b)
#elif defined __SSE3__
	#define x_and(a,b) _mm_and_ps(a,b)
#else
	static inline x128f x_and(x128f a, x128f b)
	{
		return (x128f)
			{	a.a&b.a,
				a.b&b.b,
...
//x_or
#ifdef __APPLE_ALTIVEC__
	#define x_or(a,b) vec_or(a,b)
#elif defined __SSE3__
	#define x_or(a,b) _mm_or_ps(a,b)
#else
	static inline x128f x_or(x128f a, x128f b)
	{
		return (x128f)
			{	a.a|b.a,
				a.b|b.b,
